...
- 房源 tags 含多种标签，回复详情时需结合 tags 准确体现。常见类型：看房方式(仅线下看房/仅工作日看房/线上VR看房/线上AR看房)、周边(近餐饮/近健身房/近菜市场/近警察局)、宠物(仅限小型犬)、租期(可短租/可租2个月)、费用(水电费另付/包物业费/包取暖费/免宽带费)、押付(押一付三/押二付一/押二)、其他(采光好/露天车位/房东直租/房东好沟通/绿化好/环境宜居/物业管理好)
