...
def get_tools_schema(round_num: int = 1) -> list[dict]:
    ...
    search_tools = [
        ...
        {"type": "function", "function": {"name": "get_house_by_id", "description": "查房源详情，含tags、hidden_noise_level(安静/吵闹/中等)、utilities_type(民水民电)、orientation(朝南/南北)、elevator、community。多轮追加条件时用此过滤，禁止重新搜索。注意tag语义：养金毛/大型犬→仅限小型犬=不符合应pass；养小型犬→仅限小型犬=符合", "parameters": {"type": "object", "properties": {"house_id": {"type": "string"}}, "required": ["house_id"]}}},
        ...
        {"type": "function", "function": {"name": "get_nearby_landmarks", "description": "查某小区周边地标。community必填，type可选：公园、商超、菜市场、医院、学校、餐饮、健身房等。用于回答「附近有公园吗」", "parameters": {"type": "object", "properties": {"community": {"type": "string"}, "type": {"type": "string"}}, "required": ["community"]}}},
    ]
    action_tools = [
