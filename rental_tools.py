...
def get_tools_schema(round_num: int = 1) -> list[dict]:
    ...
    search_tools = [
        ...
        {"type": "function", "function": {"name": "get_house_by_id", "description": "查房源详情，含tags、hidden_noise_level(安静/吵闹/中等)、utilities_type(民水民电)、orientation(朝南/南北)、elevator、community。多轮追加条件时用此过滤，禁止重新搜索", "parameters": {"type": "object", "properties": {"house_id": {"type": "string"}}, "required": ["house_id"]}}},
